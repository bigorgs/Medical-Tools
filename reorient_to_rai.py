...
if __name__ == '__main__':
    ...
    # parser.add_argument('--image_folder', default="./output" , type=str, required=True)
    # parser.add_argument('--output_folder', default="./output" ,type=str, required=True)
    ...
    for filename in sorted(filenames):
        ...
        reoriented.Update()
        # itk.imwrite(reoriented, os.path.join(parser_args.output_folder, basename_wo_ext + '1.nii.gz'))
        itk.imwrite(reoriented, os.path.join(output_folder, basename_wo_ext + '2.nii.gz'))